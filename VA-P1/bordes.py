...
# outImage = LoG(inImage, 1)
# outImage = LoG(inImage, 2)
# outImage = LoG(inImage, 3)
# min = np.min(outImage)
# max = np.max(outImage)
# outImage = (outImage - min) / (max - min)
# saveImage(outImage, 'imagenes-bordes/saved_LoG_3.jpg')

# outImage = edgeCanny(inImage, 2, 0.01, 0.01)
# outImage = edgeCanny(inImage, 2, 0.01, 0.8)
# outImage = edgeCanny(inImage, 2, 0.8, 0.8)
# saveImage(outImage, 'imagenes-bordes/saved_canny_3.jpg')
